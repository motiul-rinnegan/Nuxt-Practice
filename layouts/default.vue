    ...
    <header>
      <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
          <div class="flex items-center flex-shrink-0 text-white mr-6">
            ...
            <span class="font-semibold text-xl tracking-tight">Rinnegan</span>
          </div>
            <ul class="flex">
                <li class ="mr-6"><NuxtLink to="/">Home</NuxtLink></li>
                <li class ="mr-6"><NuxtLink to="/about">About</NuxtLink></li>
                <li class ="mr-6"><NuxtLink to="/products">Products</NuxtLink></li>
                <li class ="mr-6"><NuxtLink to="/blog">Blogs</NuxtLink></li>
                <li class ="mr-6"><NuxtLink to="/service">Services</NuxtLink></li>
                <li class ="mr-6"><NuxtLink to="/service">Contact Us</NuxtLink></li>
            </ul>
            
        <button class="bg-white-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
         Sign Up/Login
        </button>
